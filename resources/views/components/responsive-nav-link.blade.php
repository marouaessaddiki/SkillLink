...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-blue-600 text-start text-base font-semibold text-blue-700 bg-blue-50/70 focus:outline-none transition duration-150 ease-in-out'
