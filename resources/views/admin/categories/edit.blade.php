<x-admin-shell title="Edit Category">
    <div class="mx-auto max-w-2xl">
        ...
        <div class="mb-7">
            ...
            <h2 class="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Edit Category</h2>
            <p class="mt-1 text-sm text-slate-500">Update the category taxonomy for platform missions.</p>
        </div>
